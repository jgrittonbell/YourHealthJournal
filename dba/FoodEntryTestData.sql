...
-- Insert test data into FoodEntry
...
VALUES
    ...
    (3, 'Avocado Toast', '2024-02-17 09:15:00', 'breakfast', 14.00, 5.00, 18.00, 200.00, 0.00, 150.00, 7.00, 2.00, NULL, 0.00, 20.00, 0.90, 300.00, 'Good fats and fiber'),
    ...
    (5, 'Greek Yogurt with Honey', '2024-02-16 10:00:00', 'snack', 4.00, 10.00, 18.00, 150.00, 5.00, 55.00, 0.00, 14.00, 10.00, 2.00, 110.00, 0.80, 160.00, 'Protein-rich snack with probiotics'),
    ...
    (7, 'Spaghetti with Marinara Sauce', '2024-02-15 18:45:00', 'dinner', 5.00, 12.00, 50.00, 320.00, 15.00, 600.00, 4.00, 8.00, NULL, 0.00, 40.00, 3.00, 300.00, 'Carb-heavy meal with some protein'),
    ...
    (9, 'Protein Shake', '2024-02-14 07:45:00', 'breakfast', 2.00, 25.00, 8.00, 160.00, 10.00, 180.00, 0.00, 2.00, 1.00, 3.00, 200.00, 2.50, 450.00, 'Post-workout meal replacement'),
