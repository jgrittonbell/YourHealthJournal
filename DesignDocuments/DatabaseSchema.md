...
| `full_name`  | `VARCHAR(100)` | Yes | Full name of the user |
...
| `user_id`    | `BIGINT` (Foreign Key) | Yes | References the user who logged the meal (references `Users.id`) |
...
| `user_id`    | `BIGINT` (Foreign Key) | Yes | References the user who favorited the item (references `Users.id`) |
...
| `user_id`       | `BIGINT` (Foreign Key) | Yes | References the user who logged the reading (references `Users.id`) |
